...
export class DevServerControlsComponent implements OnInit {
  ...
  public state$: BehaviorSubject<ServerState> = new BehaviorSubject(
    ServerState.LOADING,
  );
  ...
  public launchSAMP(): void {
    try {
      ...
      if (!launchSettings)
        throw new Error("LAUNCHER_ERR: Empty launcher settings");
