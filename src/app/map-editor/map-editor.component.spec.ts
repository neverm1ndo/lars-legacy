...
describe('MapEditorComponent', () => {
  ...
  it('should filter material and text objects', () => {
    fixture.whenStable();
    const objects = [{ name: 'object' }, { name: 'vehicle '}, { name: 'text'}, { name: 'material' }];
    expect(component.filter(objects)).toEqual([{ name: 'object' }, { name: 'vehicle '}]);
  });
  ...
  it('should set another objects', () => {
    ...
    component.objects = [{ name: 'object' }, { name: 'vehicle '}, { name: 'text'}, { name: 'material' }];
