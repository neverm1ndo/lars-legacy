...
export const settings = trigger("settings", [
  ...
  transition("void => *", [
    ...
    animate(
      "0.23s cubic-bezier(0.4, 0.0, 0.2, 1)",
      keyframes([
...
export const popblur = trigger("popblur", [
  ...
  transition("void => *", [
    ...
    animate(
      "0.1s cubic-bezier(0.4, 0.0, 0.2, 1)",
      keyframes([
...
export const lazy = trigger("lazy", [
  ...
  transition("void => *", [
    ...
    animate(
      "0.15s cubic-bezier(0.4, 0.0, 0.2, 1)",
      keyframes([
...
export const settingsRoute = trigger("settingsRoute", [
  transition("* => *", [
    ...
    query(":enter", [style({ transform: "scale(0.99)", opacity: 0 })], {
      optional: true,
    }),
    ...
    group([
      query(
        ...
        [
          animate(
            "0.06s cubic-bezier(0.4, 0.0, 0.2, 1)",
