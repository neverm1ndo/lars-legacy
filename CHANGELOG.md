...
#### Fixed/ Исправлено
##### Search / Поиск
- Исправлено отображение процесса *<death/killed>*. Теперь отображается не только оружие, с которого был убит игрок.

*Добавлены новые процессы в отображение лога, исправлены некоторые ошибки, улучшено качество кода.*
